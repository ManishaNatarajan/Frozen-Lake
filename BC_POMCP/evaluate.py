...
import os
import time
from BC_POMCP.pomcp_env import FrozenLakeEnv, find_shortest_path
...
def execute(round_num, num_steps, env, human_agent, robot_agent=None):
    ...
    for step in range(num_steps):
        ...
        # # Use BC model instead
        # human_actions = list(env.get_BC_observation(env.world_state, robot_action))  # Get human action from the BC model
