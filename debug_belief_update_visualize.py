...
def view_rollout(user_data, rollout_idx=5, SEED=0):
    ...
    print(user_data[str(rollout_idx)]["reward"])
...
if __name__ == '__main__':
    ...
    with open("logs/sim_experiments/map_5/trust_5_50/ba_pomcp.json", "r") as f:
